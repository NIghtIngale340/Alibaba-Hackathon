/**
 * Enhanced Qwen Calendar Agent - Mobile Version
...
4. Validation Rules:
   ...
   - Use Asia/Manila timezone (+08:00) by default
...
export async function processCalendarEvent(
  ...
  let partialEventData = typeof input.data === 'string' ? {} : input.data;
  ...
  if (input.source === 'email') {
    ...
    partialEventData = { ...input.context.partialEvent, ...partialEventData } as Partial<ExtractedEventData>;
  }
